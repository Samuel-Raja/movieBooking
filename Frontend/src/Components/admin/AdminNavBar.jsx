          ...
          <Navbar.Toggle aria-controls={`offcanvasNavbar-expand-${expand}`}  />
            ...
            >
              ...
              { !isLogin && <Button onClick={()=> navigate("/user-login") } variant="danger" >Login</Button>  }
                ...
                <Offcanvas.Title id={`offcanvasNavbarLabel-expand-${expand}`}>
                <Button onClick={()=> navigate("/add-movies") }  variant="danger"  >Add Movies</Button>
                </Offcanvas.Title>
                </Offcanvas.Header>
              <Offcanvas.Body>
                ...
                <Button onClick={()=> navigate("/add-movies") }  variant="danger"  >Add Movies</Button>
                  ...
                  <Button onClick={()=> navigate("/add-movies") }  variant="danger" className='d-none d-lg-flex' >Add Movies</Button>
